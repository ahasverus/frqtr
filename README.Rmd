...
<!-- badges: start -->
[![R CMD Check](https://github.com/ahasverus/frqtr/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ahasverus/frqtr/actions/workflows/R-CMD-check.yaml)
...
[![Test coverage](https://github.com/ahasverus/frqtr/actions/workflows/test-coverage.yaml/badge.svg)](https://github.com/ahasverus/frqtr/actions/workflows/test-coverage.yaml)
[![codecov](https://codecov.io/gh/ahasverus/frqtr/branch/main/graph/badge.svg)](https://codecov.io/gh/ahasverus/frqtr)
[![CRAN status](https://www.r-pkg.org/badges/version/frqtr)](https://CRAN.R-project.org/package=frqtr)
...
> Casajus Nicolas (`r format(Sys.Date(), "%Y")`) frqtr: An R 
...
Please note that the `frqtr` project is released with a 
